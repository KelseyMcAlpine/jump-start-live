...
# Outputs program title to the user
puts "Kelsey McAlpine's Bio Generator"
puts "===============================\n"

# prompts user to input bio information
print "Name: "
name = gets.chomp.capitalize

print "Birthday (MM/DD/YY): "
birthday = gets.chomp
...
# outputs message to the user based on their inputs
puts "\nA Short Bio for #{name}"
puts "===================================\n"
puts "#{name} was born on #{birthday}. Fast forward to today, #{name} works as a(n) #{occupation}. After work, #{name} enjoys #{hobby} and eating #{food}."
