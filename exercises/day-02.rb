# Day 2 Exercises
# In one Ruby file, write code to solve the problems below. Your code should print out each problem statement, followed by the output from the conditional statement(s)._
...
# Question 9.
# Prompt for rate of pay and hours worked. Calculate gross pay. Provide time-and-a-half for hours worked beyond `40`  (e.g., if you get paid $10/hr and work 45 hours in a week, you would gross $745 (`40 x 10 + 5 x 15`).
...
if time <= 40
  ...
  overtime_time = time - 40
  overtime_rate = rate * 1.5
  print "You earned $#{(40 * rate) + (overtime_time * overtime_rate)}"
end
